...
fn test_claim_order() {
    ...
    let test_cases: Vec<ClaimOrderTestCase> = vec![
        ...
        ClaimOrderTestCase {
            name: "valid basic partial claim",
            operations: vec![
                OrderOperation::PlaceLimit(LimitOrder::new(
                    valid_book_id,
                    valid_tick_id,
        ...
        ClaimOrderTestCase {
            name: "valid two-step partial claim",
            operations: vec![
                OrderOperation::PlaceLimit(LimitOrder::new(
                    valid_book_id,
                    valid_tick_id,
        ...
        ClaimOrderTestCase {
            name: "valid basic partial claim (large positive tick)",
            operations: vec![
                OrderOperation::PlaceLimit(LimitOrder::new(
                    valid_book_id,
                    LARGE_POSITIVE_TICK,
        ...
        ClaimOrderTestCase {
            name: "valid two-step partial claim (large positive tick)",
            operations: vec![
                OrderOperation::PlaceLimit(LimitOrder::new(
                    valid_book_id,
                    LARGE_POSITIVE_TICK,
        ...
        ClaimOrderTestCase {
            name: "valid basic partial claim (large negative tick)",
            operations: vec![
                OrderOperation::PlaceLimit(LimitOrder::new(
                    valid_book_id,
                    LARGE_NEGATIVE_TICK,
        ...
        ClaimOrderTestCase {
            name: "valid two-step partial claim (large negative tick)",
            operations: vec![
                OrderOperation::PlaceLimit(LimitOrder::new(
                    valid_book_id,
                    LARGE_NEGATIVE_TICK,
